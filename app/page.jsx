      ...
      {adding ? (
        <motion.form layout onSubmit={handleSubmit}>
          ...
          <div className="mt-1.5 flex items-center justify-end gap-1.5">
            ...
            <button
              type="submit"
              className="flex gap-1.5 rounded px-3 py-1.5 text-xs bg-neutral-50 text-neutral-950 transition-colors hover:bg-neutral-300"
            >
              <span>Add</span>
              <FiPlus />
            </button>
        ...
        <motion.button
          ...
          className="flex w-full items-center gap-1.5 px-3 py-1.5 text-xs text-neutral-400 transition-colors hover:text-violet-400"
        >
          <span>Add Card</span>
          <FiPlus />
        </motion.button>
